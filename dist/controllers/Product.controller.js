    ...
    getListProduct(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                //   }
                // );
                const result = yield (0, Product_service_1.getProduct)(page, elementOfPage, options_["ten"], options_["loaisanphamid"], Object.assign({}, options_["book"]), Object.assign({}, options_["stationery"]));
                res.json(result);
                next();
            }
            catch (error) {
