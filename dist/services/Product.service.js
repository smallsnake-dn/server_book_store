...
function getProduct(page, elementOfPage, ten, loaisanphamid, optionsBook, optionsStationery) {
            ...
            try {
                ...
                const result = yield prisma_client_1.default.sanpham.findMany({
                    ...
                    where: {
                        ...
                        loaisanphamid,
                        sach: optionsBook_ !== undefined && loaisanphamid === 2
                            ? {
                                ngonngu: {
