    ...
    return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const result = yield prisma_client_1.default.sanpham.findMany({
                ...
                take,
                where: {
                    loaisanphamid: undefined,
                    // vanphongpham : {
                    //     ...options
                    // },
                    vanphongpham: undefined,
                    sach: undefined
                },
                include: {
                    vanphongpham: {
...
exports.getStationery = getStationery;
